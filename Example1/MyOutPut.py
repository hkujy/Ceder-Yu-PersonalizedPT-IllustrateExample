...
def pas(pas: PasClass):
    ...
    with open(outfile, "wt") as f:
        print("Pas,Path,Fare,Travel,Wait,W_Fare,W_Travel,W_Wait,WeightedCost",  file=f)
        for o in pas:
            for p in o.paths:
                print("{0},{1},{2},{3},{4},{5},{6},{7},{8}".
                      format(o.id, p.att['Travel'], p.att['Fare'], p.att['Wait'], o.para.weight['Fare'],
                             o.para.weight['Travel'], o.para.weight['Transfer'],
